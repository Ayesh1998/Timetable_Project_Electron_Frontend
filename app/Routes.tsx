  ...
  return (
    <App>
      <Switch>
        ...
        />
        <Route path={routes.SESSIONS_ADD} component={SessionsAddView}
        />
        <Route path={routes.SESSIONS_LIST} component={SessionsListView}
        />
        <Route path={routes.LECTURERS_ADD} component={LecturersAddView}
        />
        <Route path={routes.LECTURERS_EDIT} component={LecturersEditView}
        />
        <Route
          path={routes.LECTURERS_LIST_VIEW}
          component={LecturersListView}
        />
        <Route path={routes.SUBJECTS_ADD} component={SubjectsAddView}
        />
        <Route path={routes.SUBJECTS_EDIT} component={SubjectsEditView}
        />
        <Route path={routes.SUBJECTS_LIST_VIEW} component={SubjectsListView}
        />
        <Route path={routes.GROUPS_ADD} component={GroupsAdd}
        />
        <Route path={routes.GROUPS_LIST_VIEW} component={GroupsListView}
        />
        <Route
          path={routes.GROUPS_LIST_VIEW_EDIT}
          component={GroupsListViewEdit}
        />
        <Route path={routes.GROUPS_EDIT} component={GroupsEdit}
        />
        <Route path={routes.GROUPS_SINGLE_VIEW} component={GroupsSingleView}
        />
        <Route
          path={routes.GROUPS_SINGLE_SUB_VIEW}
          component={SubGroupsSingleView}
        />
        <Route path={routes.TAGS_ADD} component={TagsAdd}
        />
        <Route path={routes.TAGS_EDIT} component={TagsEdit}
        />
        <Route path={routes.TAGS_LIST_VIEW} component={TagsListView}
        />
        <Route path={routes.YEARSEMS_ADD} component={YearSemsAdd}
        />
        <Route path={routes.YEARSEMS_EDIT} component={YearSemsEdit}
        />
        <Route path={routes.YEARSEMS_LIST_VIEW} component={YearSemsListView}
        />
        <Route path={routes.GROUPNUMS_ADD} component={GroupNumsAdd}
        />
        <Route path={routes.GROUPNUMS_EDIT} component={GroupNumsEdit}
        />
        <Route
          path={routes.GROUPNUMS_LIST_VIEW}
          component={GroupNumsListView}
        />
        <Route path={routes.SUBGROUPNUMS_ADD} component={SubGroupNumsAdd}
        />
        <Route path={routes.SUBGROUPNUMS_EDIT} component={SubGroupNumsEdit}
        />
        <Route
          path={routes.SUBGROUPNUMS_LIST_VIEW}
          component={SubGroupNumsListView}
        />
        <Route path={routes.PROGRAMS_ADD} component={ProgramsAdd}
        />
        <Route path={routes.PROGRAMS_EDIT} component={ProgramsEdit}
        />
        <Route path={routes.PROGRAMS_LIST_VIEW} component={ProgramsListView}
        />
        ...
        />
        <Route
          path={routes.STATISTICS_OF_LECTURERS}
          component={LecturersStatisticsPage}
        />
        <Route
          path={routes.STATISTICS_OF_STUDENTS}
          component={StudentsStatisticsPage}
        />
        <Route
          path={routes.STATISTICS_OF_SUBJECTS}
          component={SubjectsStatisticsPage}
        />
        <Route
          path={routes.ROOMS_UNAVAILABILITY}
          component={RoomsUnavailabilityPage}
        />
        <Route path={routes.ADD_ROOMS} component={AddRoomsPage}
        />
        <Route
          path={routes.ASSIGN_ROOMS_FOR_SESSIONS}
